        ...
        (
            ...
            function (factory) {
                ...
                function lexicographicComparison(a, b) {
                    ...
                    // e.g. abc100 < abc99
                    // e.g. aaa < bbb
                    var lexiResult = (aText < bText) ? A_COMES_FIRST : B_COMES_FIRST;
                    if (lexiResult === A_COMES_FIRST) {
                        console.log(aText + " kommt als erstes, " + bText + " als zweites.");
                    } else {
                        console.log(bText + " kommt als erstes, " + aText + " als zweites.");
                    }
