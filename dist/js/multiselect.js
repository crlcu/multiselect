        ...
        **/
        function Multiselect($select, settings) {
            ...
            this.options = {
                ...
                singleClick: settings.singleClick !== undefined ? settings.singleClick : true,
            };

            delete settings.keepRenderingSort, settings.submitAllLeft, settings.submitAllRight, settings.search, settings.ignoreDisabled, settings.matchOptgroupBy, settings.singleClick;
        ...
        Multiselect.prototype = {
            ...
            events: function () {
                ...
                if (self.options.singleClick && self.options.singleClick) {
